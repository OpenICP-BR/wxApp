...
void wxCrafter90S2iSInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/V1_drafts_bitmaps.cpp$_Users_gqueiroz_go_src_github.com_OpenICP-BR_wxApp_res_V1_drafts_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/V1_drafts_bitmaps.cpp$_Users_gqueiroz_go_src_github.com_OpenICP-BR_wxApp_res_V1_drafts_bitmaps.xrc"));
}
